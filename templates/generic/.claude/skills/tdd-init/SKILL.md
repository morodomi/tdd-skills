...
このセクションでプロジェクト固有の検証ロジックを追加できます。

例:
- 特定のファイルの存在確認（package.json, requirements.txt等）
- プロジェクト構造の検証
- 必要な依存関係の確認

カスタマイズ方法は CLAUDE.md を参照してください。
...
docs/20251028_1545_CSVエクスポート機能.md
docs/20251029_1000_検索機能追加.md
```
