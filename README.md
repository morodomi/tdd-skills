...
ClaudeSkillsは、複数のプロジェクトタイプ向けのテンプレートを提供しています。

### Generic (Language/Framework Agnostic)
- **Path**: `templates/generic/`
- **Documentation**: [GENERIC_INSTALLATION.md](docs/GENERIC_INSTALLATION.md)
- **Use Case**: 任意のプロジェクトで使用可能な最小コアテンプレート
- **Customization**: 言語/フレームワーク固有のルールを追加してカスタマイズ
- **Examples**: Laravel版とBedrock版がカスタマイズ例として利用可能
- **Supported Languages**: Node.js, Python, PHP, Go, Rust等、任意の言語
- **Supported Test Frameworks**: Jest, pytest, PHPUnit, Go test, cargo test等

### Laravel
- **Path**: `templates/laravel/`
- **Documentation**: [LARAVEL_INSTALLATION.md](docs/LARAVEL_INSTALLATION.md)
- **Use Case**: Laravel固有のテストルール、PHPStan Level 8、Laravel Pint
- **Quality Tools**: PHPUnit/Pest, PHPStan, Laravel Pint
- **Features**:
  - テストディレクトリ構造ガイド
  - 大規模プロジェクト向け高速化ガイド
  - フェーズ自動遷移
...
### Bedrock/WordPress
- **Path**: `templates/bedrock/`
- **Documentation**: [BEDROCK_INSTALLATION.md](docs/BEDROCK_INSTALLATION.md)
- **Use Case**: WordPress/Bedrock環境でのプラグイン/テーマ開発
- **Quality Tools**: PHPUnit (wp-phpunit), PHPStan, Laravel Pint, Brain Monkey
- **Features**:
...
│   ├── GENERIC_INSTALLATION.md  # 汎用インストールガイド
│   ├── BEDROCK_INSTALLATION.md  # Bedrock/WordPressインストールガイド
│   └── MCP_INSTALLATION.md      # MCP統合ガイド
│
├── templates/                   # 配布用テンプレート
│   ├── generic/                 # 汎用テンプレート（任意の言語/FW）
│   │   ├── .claude/skills/
│   │   ├── CLAUDE.md.example
│   │   └── install.sh
│   │
│   ├── laravel/                 # Laravel用テンプレート
│   │   ├── .claude/skills/
│   │   ├── CLAUDE.md.example
│   │   └── install.sh
│   │
│   └── bedrock/                 # Bedrock/WordPress用テンプレート
│       ├── .claude/skills/
│       ├── CLAUDE.md.example
│       └── install.sh
│
...
- [完了] Phase 5: 汎用TDDテンプレート（任意の言語/フレームワーク対応）（2025-11-04）
...
#### Phase 5: 汎用TDDテンプレート ✅ **完了**

**完了日**: 2025-11-04

- [完了] 言語/フレームワーク非依存の最小コアテンプレート
- [完了] 汎用Skillsファイル（7つのフェーズ）
- [完了] カスタマイズガイドライン
- [完了] 複数言語の使用例（Node.js, Python, PHP）
- [完了] 包括的なインストールガイド

**ドキュメント**:
- [Phase 5 TDD Document](docs/20251104_1530_Phase5_汎用TDDテンプレート.md) - 汎用テンプレートの要件定義・実装ドキュメント
- [Generic Installation Guide](docs/GENERIC_INSTALLATION.md) - 汎用テンプレートのインストールガイド

**主な成果物**:
- `templates/generic/` - 汎用TDDテンプレート
- `templates/generic/.claude/skills/` - 7つの汎用Skillsファイル
- `templates/generic/CLAUDE.md.example` - カスタマイズ可能なプロジェクト設定テンプレート
- `templates/generic/install.sh` - 汎用インストールスクリプト
- `docs/GENERIC_INSTALLATION.md` - インストールガイド（Node.js/Python/PHP例）
...
*最終更新: 2025-11-04*
*開発状況: ✅ Phase 5完了 - 3つのテンプレート（Generic/Laravel/Bedrock）実装完了 + MCP統合（Git/Filesystem/GitHub）*
